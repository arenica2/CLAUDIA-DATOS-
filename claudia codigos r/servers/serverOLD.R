...
shinyServer(function(input, output, session) {
  ...
  observeEvent(input$userLogin,{
    ...
    if(loginSuccess) {
      ...
      #                             message = "Identificatioón incognido")
      # })
    }
...
#    )
  ...
  #Funcion que me devolverá las viviendas a las que se tiene que volver el dia en que se consulta
  ...
  #Funcion que me devolverá las viviendas que se ingresaron en el dia
